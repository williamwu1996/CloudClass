...
public class Teacher_checkin_code extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txlatitude = findViewById(R.id.teacher_checkin_code_latitude);
        txlongitude = findViewById(R.id.teacher_checkin_code_longitude);
        ...
        code4.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (m.matches()) {
                    ...
                    System.out.println("--------------longitude is "+ txlongitude.getText().toString());
                    System.out.println("--------------latitude is " + txlatitude.getText().toString());
                    System.out.println("code is " +txcode);
                    Intent intent =  new Intent(Teacher_checkin_code.this,Checkin_going.class);
                    intent.putExtra("cid",cid);
                    intent.putExtra("longitude",txlongitude.getText().toString());
                    intent.putExtra("latitude",txlatitude.getText().toString());
